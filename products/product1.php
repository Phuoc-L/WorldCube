...
session_start();
    ...
    addVisitedPage('Hydrogen (H)', 'products/product1.php');
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST')
    {
        ...
        else
        {
            ...
            $product_name = 'Hydrogen (H)';
            $url = 'https://phuocle.website/products/product1.php';  
...
<html lang="en">
    <head>
        ...
        <title>World Cube - Hydrogen (H)</title>
        <!-- Favicon-->
        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Hydrogen (H) Cube</h1>
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4">
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="../images/Hydrogen.png" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Hydrogen (H)</h5>
                                    <!-- Product price-->
                                    $40.00 - $80.00
                                </div>
                            </div>
                        ...
                        <div class="card h-100" style="width: 900px;">
                            ...
                            <div class="card-body p-4">
                                <div class="text-start">
                                    <!-- Card Title-->
                                    <h5 class="fw-bolder">Hydrogen (H) Cube Overview</h5>
                                    <!-- Card Description-->
                                    <b>Description:</b> <br>
                                    Discover the essence of chemistry with our Hydrogen (H) Cube. Crafted 
                                    ...
                                    representation of Hydrogen's atomic structure make it an ideal addition to 
                                    any science enthusiast's collection. Whether for educational purposes or as 
                                    a unique decorative piece, our Hydrogen cube is sure to spark curiosity and 
