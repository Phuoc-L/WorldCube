    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST')
    {
        ...
        else
        {
            ...
            if (mysqli_query($conn, $sql)) {
                ...
                // send info to create account in phuc website domain
                send_create_account($username, $password, $firstname, $lastname, $email, $address, $homephone, $cellphone, "https://phucle.website/api/signupEP.php");
                // send info to create account in phuong website domain
                send_create_account($username, $password, $firstname, $lastname, $email, $address, $homephone, $cellphone, "https://cmpe272.phuongngo.net/users/create_new_user.php");
                // send info to create account in vinh website domain
                send_create_account($username, $password, $firstname, $lastname, $email, $address, $homephone, $cellphone, "https://vinhtran00.com/create_user_endpoint.php");
                // Close connection
                mysqli_close($conn);
                // redirect
...
<html lang="en">
    <head>
        ...
        <title>SJSU Marketplaces- Sign up</title>
        <!-- Favicon-->
